...
(cd evm-benchmarks-asm384/evmmax_generator && python3 generate.py MULMONTX 6 6) > $benchmark_dir/geth-evm-asm384.csv
(cd evm-benchmarks-asm384/evmmax_generator && python3 generate.py ADDMODX 6 6) >> $benchmark_dir/geth-evm-asm384.csv
(cd evm-benchmarks-asm384/evmmax_generator && python3 generate.py SUBMODX 6 6) >> $benchmark_dir/geth-evm-asm384.csv

echo "running little-endian benchmarks"
(cd evm-benchmarks-le/evmmax_generator && python3 generate.py) > $benchmark_dir/geth-evm-little-endian.csv
echo "running big-endian EVM benchmarks"
(cd evm-benchmarks-eip-5843/evmmax_generator && python3 generate.py) > $benchmark_dir/geth-evm-eip-5843.csv
